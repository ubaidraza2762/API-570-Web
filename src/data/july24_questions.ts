...
export const API_570_JULY_2024_FINAL: Question[] = [
  {
    id: "july24-1",
    text: "(1) Records note that an NPS 10 (DN 250) 90 degree elbow pipe has repeatedly failed in service due to grooving, this indicates that the elbow has most likely been subjected to:",
    options: [
      "a. Numerous individual impacts of solid or liquid particles causing erosion",
      "b. Sour water or steam containing hydrogen sulphide",
      "c. Saturated steam accompanied by poor manufacturer",
      "d. Hot acid salts cause corrosion."
    ],
    correctAnswer: 0,
    hint: "Grooving in elbows often points to erosion or erosion-corrosion mechanisms."
  },
  {
    id: "july24-2",
    text: "(2) According to PCC-2, why it may be necessary to preheat the material prior to welding?",
    options: [
    ...
    correctAnswer: 0,
    hint: "Preheating helps minimize hydrogen cracking and reduces the cooling rate."
  },
  {
    id: "july24-3",
    text: "(3) At what metal temperature chloride stress corrosion cracking can occur in austenitic stainless steel?",
    options: [
      "a. Below -20°F",
      "b. Below 40°F",
      "c. Above 140°F",
    ...
    correctAnswer: 2,
    hint: "CI SCC in 300-series stainless steel typically triggers above 140°F (60°C)."
  },
  {
    id: "july24-4",
    text: "(4) Which of the following would justify the use of more than normal number of CML location on piping system?",
    options: [
      "a. Chrome piping that has not been PWHT",
      "b. High potential for environmental impact in the event of leak",
      "c. Excessive line vibration",
      "d. Long straight run piping system"
    ],
    correctAnswer: 1,
    hint: "Higher consequence areas require more detailed monitoring per API 570."
  },
  {
    id: "july24-5",
    text: "(5) When identifying material, resistivity testing:",
    options: [
      "a. Sorts and identifying a wide range of ferrous and non-ferrous material",
      "b. Identify only few ferrous material",
      "c. Identify only a few non-ferrous material",
      "d. Sorts only low chrome (5%) and austenitic stainless-steel material"
    ],
    correctAnswer: 0,
    hint: "Resistivity is a key PMI technique for sorting various alloys."
  },
  {
    id: "july24-6",
    text: "(6) What type of damage is typically from acid sour water corrosion?",
    options: [
      "a. Local thinning",
      "b. General thinning",
      "c. Blistering",
  ...
  },
  {
    ...
    options: [
      ...
      "d. The qualified piping engineer."
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Piping that can be valued off without significant affecting the process unit operability",
      "c. Large diameter instrument and machinery piping that can be isolated",
      "d. Piping associated with spare pump and instrument that is normally not in operation."
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "c. Lap patch, without rounded corner",
      "d. No temporary repair can be made on in service piping system."
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Any piping that is in use only periodically and off-site piping that normally out of the process",
  ...
  },
  {
    ...
    options: [
      "a. The owner/user",
      "b. Contractor's welding QC",
      "c. Manufacturer or fabricator",
      "d. The inspector or the piping engineer"
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "b. An ASNT TC-1A certified examiner",
  ...
  },
  {
    ...
    options: [
      ...
      "b. NDE can be substituted for pressure tests after consultation with inspector or engineer",
      "c. The replaced portion of the piping system must be pressure tested",
      "d. The inspector may exempt welds in these services from NDE and pressure testing"
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Several NDE techniques to check for various types of damage that pertain to the circuits as consider during inspection planning",
      "c. Primarily thickness measurement to determine the short- and long-term corrosion rate of the piping circuits identified in the inspection plan",
      "d. Primarily any issue that can cause external degradation like CUI, atmospheric corrosion, dew point corrosion, mechanical damage, deterioration of paint and insulation"
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Laboratory chemical analysis",
      "c. Portable x-ray fluorescence",
      "d. Magnetic testing."
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "b. When the inspector is satisfied with the competency of repair organization",
      "c. When the inspector has been given the approval to do so by their supervisor",
  ...
  },
  {
    ...
    options: [
      ...
      "b. Radiography and/or magnetic particle testing",
      "c. Radiograph and/or ultrasonic",
      "d. Ultrasonic and/or eddy current."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Microwave examination can examine the refractory for volumetric flaws.",
  ...
  },
  {
    ...
    options: [
      ...
      "b. Individual circumstances and NDE technique",
      "c. The process service",
  ...
  },
  {
    ...
    options: [
      ...
      "b. Longitudinal cracks that might propagate from under the sleeve",
      "c. Circumferential cracks greater than half the circumference",
      "d. Through wall holes."
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Inspect and service the device whenever the vessel is schedule for inspection",
      "c. Do not allow the intervals to exceed 10 years",
      "d. Consider the performance of the device based on service condition."
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Develop means to ensure continued safe operation",
      "c. Recommend the piping be restrained to prevent further movement",
      "d. Consult with piping engineer about piping stress analysis"
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Along the centre line of the weld",
      "c. Adjacent to the weld and parallel to the centre line",
      "d. Perpendicular to the centre line of the weld"
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      ...
      "c. Owner/operator or fabricator",
      "d. Inspector or piping engineer"
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "b. The location should be logged in the inspection record and the surface marked",
      "c. The piping should be permanently repaired within 5 years",
      "d. The piping must be leak tested before returning to service"
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Before a valve is placed back into service",
  ...
  },
  {
    ...
    options: [
      ...
      "d. Check piping for stress corrosion cracking if insulation contained chlorides"
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "c. Validate condition monitoring location",
  ...
  },
  {
    ...
    options: [
      ...
      "b. Conform to applicable code",
      "c. Always be less than 225 BHN hardness",
      "d. Be approved by repair organization’s QC inspector"
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Acceptance to RT film images that indicates no rejectable defects",
      "c. The absence of light symbol “B” and that the IQI meets requirements",
      "d. Demonstration that the film density and IQI requirement meet code."
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Device used to check the heat treatment temperature",
      "c. Flammable material that when ignited will create enough heat to stress relieve piping",
      "d. Vibration device that generates heat through friction and produces a stress relieved weldment"
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "b. The piping component is hydrotested to 150% of the MAWP",
  ...
  },
  {
    ...
    options: [
      ...
      "d. Four pin soil resistivity meters."
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "c. Place where axial corrosion is most likely to occur",
      "d. Accessibility of CML"
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Small-bore piping can receive more extensive inspection",
      "c. Higher classified piping system receive more extensive inspection at shorter intervals",
      "d. Lower-classified piping systems can be eliminated from the inspection program"
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Jurisdictional requirement always governs",
      "c. Authorized inspector has discretion to follow either API 570 or jurisdiction",
  ...
  },
  {
    ...
    options: [
      ...
      "b. Measurement on thinnest point be repeated at the same location",
      "c. Industry qualified UT examiners are utilized",
      "d. UT measurement are taken below 150F to ensure accuracy."
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Have a SMYS of not more than 40000 PSI",
      "c. Be 100% RT",
      "d. Have rounded corners 1-inch minimum radius."
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      "a. Optional",
      "b. Performed at same interval as for class 1 primary process piping",
      "c. Performed at same interval as for class 2 primary process piping",
      "d. Performed at same interval as for class 3 primary process piping"
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "b. c-clamp shall be installed on the valve to prevent the valve from opening during test",
      "c. The hydrotest pressure on the piping should be controlled to avoid popping the valve during test",
  ...
  },
  {
    ...
    options: [
      ...
      "b. Subsurface cracks",
      "c. General uniform thickness loss",
  ...
  },
  {
    ...
    options: [
      ...
      "b. Flow accelerated corrosion and pitting",
      "c. Iron oxide scale formation and low PH",
      "d. Dissolved nitrogen dioxide and high PH"
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Galvanized coating and a cathodic protection system",
      "c. Corrosion resistant coating and a special backfill",
      "d. Special backfill and a cathodic protection system"
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Type of material of construction and type of damage mechanism",
      "c. Whether the examiner is trying to detect or quantify the piping damage",
      "d. Whether the damage of interest is on the OD or OD of the piping component"
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Ensuring that there are no visual deformation, misalignment, and displacement",
      "c. Verifying that the expansion joint has a minimum of 8 convolutions",
      "d. Ensuring that a spring hanger or spring can support is within 6 pipe diameters"
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "b. In application of clad stainless steel",
      "c. At or adjacent to non PWHT carbon steel weld",
      "d. In pure alkanolamine subject to highly hot worked parts."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Corrected before welding proceeds further",
      "c. Segregated for further evaluation",
      "d. Radiograph for quality"
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "c. Inspecting pipe support, guide and anchors",
      "d. Obtaining measurement at CML"
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "b. Soften the weld metal",
      "c. Increase the toughness",
  ...
  },
  {
    ...
    options: [
      ...
      "b. Hydrogen cracking in carbon steel",
      "c. Arc strike in austenitic stainless steel",
      "d. Solidification cracking in austenitic stainless steel"
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "b. The highest known corrosion rate on the unit",
      "c. Worst case industry date",
      "d. Default corrosion rate of 10 min per year"
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "b. The HAZ is likely to experience stress corrosion cracking",
      "c. The grain boundary may experience severe intergranular corrosion",
      "d. The mechanical strength of the weldment is likely to decrease by 10%"
    ],
    correctAnswer: 2,
    hint: "Sensitization depletes Chrome at grain boundaries."
  },
  {
    id: "july24-90",
    text: "(90) Without an RBI analysis, class 1 piping has recommended maximum inspection intervals of:",
    options: [
      "a. 3 years for thickness measurement and 3 years for external visual inspection",
      "b. 5 years for thickness measurement and 5 years for external visual inspection",
  ...
  {
    id: "july24-91",
    text: "(91) Insert patch (flush patch) repair are:",
    options: [
      "a. Allowed for class 1 and class 2 piping system if the weld receive MPI or PT",
      "b. Not allowed for class 1 piping system",
      "c. Allowed for class 1 and class 2 piping system if the weld receive 100% RT or UT",
      "d. Not allowed for class 1 or class 2 piping system"
    ],
    correctAnswer: 2,
    hint: "Volumetric examination is required for full-penetration flush patches."
  },
  {
    id: "july24-92",
    text: "(92) In assessing the consequences of failure, while conducting RBI on piping system an important step identifying and evaluating:",
    options: [
      "a. The effectiveness of the past inspections",
      "b. Potential damage mechanism",
      "c. Current piping condition",
      "d. Potential damage from release"
    ],
    correctAnswer: 3,
    hint: "Consequence analysis looks at the impact of the release (fire, toxic, etc)."
  }
];
